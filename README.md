...
This sample app takes the [hello-kubernetes](https://github.com/dapr/quickstarts/tree/master/tutorials/hello-kubernetes) tutorial and updates it to showcase Dapr error codes and metrics.
...
## TODO: **THE FOLLOWING NEEDS TO BE UPDATED WIP**
